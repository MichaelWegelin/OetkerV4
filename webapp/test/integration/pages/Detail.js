						...
						success: function(aEntitySet) {
							...
							return this.waitFor({
								...
								check: function(oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("BpId");

									var iLength = aEntitySet.filter(function(oLineItem) {
										return oLineItem.BpId === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							return this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "text",
									value: "ProductSet (" + iNumberOfItems + ")"
								}),
								success: function() {
				...
				theShareTileButtonShouldContainTheRememberedObjectName: function() {
					return this.waitFor({
						...
						matchers: function(oButton) {
							var sObjectName = this.getContext().currentListItem.getBindingContext().getProperty("CompanyName");
