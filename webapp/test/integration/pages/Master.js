								...
								success: function(oList) {
									var aItemsNotInTheList = aEntityData.filter(function(oObject) {
										return !oList.getItems().some(function(oListItem) {
											return oListItem.getBindingContext().getProperty("BpId") === oObject.BpId;
										});
									});
									...
									this.getContext().currentId = aItemsNotInTheList[0].BpId;
								},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						success: function() {
							QUnit.ok(true, "The list header displays 'BusinessPartnerSet (0)'");
						},
