sap.ui.define([
	...
	"sap/ui/Device",
	"com/oetker/demo/model/models",
	"com/oetker/demo/controller/ListSelector",
	"com/oetker/demo/controller/ErrorHandler",
	"com/oetker/demo/model/formatter"
], function(UIComponent, Device, models, ListSelector, ErrorHandler) {
	"use strict";

	return UIComponent.extend("com.oetker.demo.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "com.oetker.demo.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "com.oetker.demo.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/sap/ZMWE_EPM_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				...
				"routes": [{
					...
					"pattern": "BusinessPartner/Display/{objectId}",
					"name": "object",
					"target": ["master", "object"]
				}, {
					"pattern": "BusinessPartner/Edit/{objectId}",
					"name": "edit",
					"target": ["master", "create"]
				}, {
					"pattern": "BusinessPartner/Create",
					"name": "create",
					"target": ["create", "master"]
				}],
