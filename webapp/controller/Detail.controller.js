...
sap.ui.define([
	...
	return BaseController.extend("com.oetker.demo.controller.Detail", {
		...
		onEdit: function(oEvent) {
			...
			var oPartner = this.getOwnerComponent().getModel().getProperty(sPath);			
			this.getRouter().navTo("edit", {objectId: oPartner.BpId});
		},
		...
		onDelete: function(oEvent) {
			...
			MessageBox.show("Are you sure?",
				{
					title: "Business Partner will be deleted",
						...
						if(action === sap.m.MessageBox.Action.YES) {
						  	oModel.remove(sPath, {
						  		success: function(oData, oResponse) {
						  			MessageBox.show("Business Partner wurde gelöscht", {
						  				icon: sap.m.MessageBox.Icon.SUCCESS,
						  				title: "Alles weg"
						  			});
									oController.getRouter().navTo("master");
						  		},
